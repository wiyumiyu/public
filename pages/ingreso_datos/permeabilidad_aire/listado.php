<?php
$pageTitle = "Permeabilidad del Aire";
ob_start();
?>
...
<div class="container-fluid page-inner">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/pages/ingreso_datos/permeabilidad_aire/formulario.php"
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-header pb-2">
            ...
            <div class="text-muted fs-13">
                Determinación de la permeabilidad del aire del suelo para evaluar
                la continuidad y conectividad de los poros.
            </div>
        </div>
                ...
                <table class="table align-middle table-hover mb-0">
                    ...
                    <thead>
                        <tr class="border-bottom">
                            ...
                            <th class="fw-bold text-muted text-center">Ka promedio</th>
                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="/pages/ingreso_datos/permeabilidad_aire/formulario.php?ensayo=<?= $e['codigo'] ?>"
